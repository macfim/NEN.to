import{r as c}from"./index.70bdfec4.js";function p(t,n){if(t!=null){if(typeof t=="function"){t(n);return}try{t.current=n}catch{throw new Error(`Cannot assign value '${n}' to ref '${t}'`)}}}function S(...t){return n=>{t.forEach(e=>{p(e,n)})}}function R(...t){return c.exports.useMemo(()=>S(...t),t)}var f={exports:{}},a={};/**
 * @license React
